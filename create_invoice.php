		...
		<div class="load-animate animated fadeInUp">
			<div class="row">
				<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
					<h2 class="title">Create Window</h2>
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<table class="table table-bordered table-hover" id="invoiceItem">	
						...
						<tr>
							...
							<!-- //Updation part -->
							<td><input type="number" name="l[]" id="l" class="form-control quantity" autocomplete="off"></td>
							<td><input type="number" name="w[]" id="b" class="form-control price" autocomplete="off"></td>
							<td><input type="number" name="sq[]" id="sq" class="form-control price" autocomplete="off"></td>
							<!-- //updation part end -->
